...
/** A wrapper class to be used as function param for {@link org.apache.gobblin.temporal.util.nesting.workflow.NestingExecWorkflow#performWorkload(NestingExecWorkloadInput)}*/
@Data
