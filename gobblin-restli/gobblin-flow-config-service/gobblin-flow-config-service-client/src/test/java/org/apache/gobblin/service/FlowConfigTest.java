...
public class FlowConfigTest {
  ...
  public void setUp() throws Exception {
    ...
    when(mockListener.onAddSpec(ArgumentMatchers.argThat((FlowSpec flowSpec) ->
        !_compilationFailureFlowPaths.contains(flowSpec.getUri().getPath())))).thenReturn(new AddSpecResponse<>(""));
  ...
  public void testCreateBadSchedule() throws Exception {
    ...
    try {
      ...
      Assert.assertEquals(e.getStatus(), com.linkedin.restli.common.HttpStatus.S_422_UNPROCESSABLE_ENTITY.getCode());
      return;
    }
  ...
  public void testDelete() throws Exception {
    ...
    try {
      ...
      Assert.assertEquals(e.getStatus(), com.linkedin.restli.common.HttpStatus.S_404_NOT_FOUND.getCode());
      return;
    }
