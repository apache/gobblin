...
public interface MultiActiveLeaseArbiter {
   ...
   *
   * @param dagActionLeaseParams                   uniquely identifies the flow, the present action upon it, the time the action
   ...
   * @throws IOException
   */
  LeaseAttemptStatus tryAcquireLease(DagActionStore.DagActionLeaseParams dagActionLeaseParams, boolean adoptConsensusFlowExecutionId)
      throws IOException;
