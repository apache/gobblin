...
public class GobblinServiceManager implements ApplicationLauncher {
  ...
  public void start() throws ApplicationException {
    ...
    // This has to be after the topologyCatalog service is launched
    if (this.isTopologySpecFactoryEnabled) {
    ...
    // Register Scheduler to listen to changes in Flows
    // This has to be after topologySpecFactory has updated spec store, so that listeners will have the latest updates.
    if (isSchedulerEnabled) {
