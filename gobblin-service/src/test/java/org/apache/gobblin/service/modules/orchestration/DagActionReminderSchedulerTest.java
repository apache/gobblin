...
public class DagActionReminderSchedulerTest {
  ...
  public void testCreateReminderJobDetail() {
    ...
    JobDetail jobDetail = DagActionReminderScheduler.createReminderJobDetail(new DagActionStore.DagActionLeaseParams(launchDagAction, false, expectedEventTimeMillis), false);
