...
public class GobblinServiceJobSchedulerTest {
  ...
  public void testJobSchedulerAddFlowQuotaExceeded() throws Exception {
    ...
    GobblinServiceJobScheduler scheduler = new GobblinServiceJobScheduler("testscheduler",
        ConfigFactory.empty(), Optional.absent(), Optional.of(flowCatalog), null, mockOrchestrator, schedulerService, Optional.of(new InMemoryUserQuotaManager(quotaConfig)), Optional.absent(), false, true);
    ...
    GobblinServiceJobScheduler schedulerWithWarmStandbyEnabled = new GobblinServiceJobScheduler("testscheduler",
        ConfigFactory.empty(), Optional.absent(), Optional.of(flowCatalog), null, mockOrchestrator, schedulerService, Optional.of(new InMemoryUserQuotaManager(quotaConfig)), Optional.absent(), true, true);
  ...
  class TestGobblinServiceJobScheduler extends GobblinServiceJobScheduler {
    ...
    public TestGobblinServiceJobScheduler(String serviceName, Config config,
      ...
      super(serviceName, config, Optional.absent(), flowCatalog, topologyCatalog, orchestrator, schedulerService, quotaManager, Optional.absent(), isWarmStandbyEnabled, true);
