...
public class TestJsonIntermediateToAvroConverter {
  ...
  public void setUp()
    ...
    Gson gson = new Gson();
    jsonSchema = gson.fromJson(new InputStreamReader(this.getClass().getResourceAsStream("/schema.json")), listType);

    listType = new TypeToken<JsonObject>() {
    }.getType();
    jsonRecord = gson.fromJson(new InputStreamReader(this.getClass().getResourceAsStream("/record.json")), listType);
