 ...
 */
@Slf4j
public class Kafka10DataWriter<D> implements AsyncDataWriter<D> {
  ...
  public Kafka10DataWriter(Properties props) {
    this(getKafkaProducer(props), ConfigFactory.parseProperties(props));
  }

  public Kafka10DataWriter(Producer producer, Config config) {
