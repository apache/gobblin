...
/**
 * Unit test for {@link EnvelopeSchemaDecorator}
 */
public class EnvelopeSchemaDecoratorTest {
  ...
  public void testConverter()
    ...
    workUnitState
        .setProp(EnvelopeSchemaConverter.KAFKA_REGISTRY_FACTORY, MockKafkaAvroSchemaRegistryFactory.class.getName());

    EnvelopeSchemaDecorator converter = new EnvelopeSchemaDecorator();
