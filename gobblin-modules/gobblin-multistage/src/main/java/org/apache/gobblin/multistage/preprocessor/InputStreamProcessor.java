...
/**
 * a base class for dynamic preprocessor creation
 */
abstract public class InputStreamProcessor {
  // payload for any preprocessor that has additional parameters
  // other than the input stream itself
