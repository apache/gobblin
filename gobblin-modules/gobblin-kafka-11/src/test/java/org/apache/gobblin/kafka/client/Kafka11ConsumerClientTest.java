...
public class Kafka11ConsumerClientTest {
    ...
    public void testConsume() throws Exception {
        ...
        try (Kafka11ConsumerClient<String, String> kafka11Client = new Kafka11ConsumerClient<>(testConfig, consumer);) {

            // Consume from 0 offset
            Set<KafkaConsumerRecord> consumedRecords =
                    Sets.newHashSet(kafka11Client.consume(new KafkaPartition.Builder().withId(0).withTopicName("test_topic")
                            .build(), 0l, 100l));

            Set<Kafka11ConsumerClient.Kafka11ConsumerRecord<String, String>> expected =
                    ImmutableSet.of(new Kafka11ConsumerClient.Kafka11ConsumerRecord<>(record0),
                            new Kafka11ConsumerClient.Kafka11ConsumerRecord<>(record1), new Kafka11ConsumerClient.Kafka11ConsumerRecord<>(record2));
