 ...
 */
@Slf4j
public class Kafka11DataWriter<D> implements AsyncDataWriter<D> {
    ...
    public Kafka11DataWriter(Properties props) {
        this(getKafkaProducer(props), ConfigFactory.parseProperties(props));
    }

    public Kafka11DataWriter(Producer producer, Config config) {
