...
/**
 * AWS specific event constants to be used with an {@link gobblin.metrics.event.EventSubmitter}.
 *
 * @author Abhishek Tiwari
 */
public class GobblinAWSEventConstants {

  public static final String EVENT_NAMESPACE = "gobblin.aws";
  public static final String EVENT_CONTEXT_NAME = "GobblinAWS";
