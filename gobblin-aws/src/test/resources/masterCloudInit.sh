...
wget -P "${jr}" "${jrS3}"myjar4.jar
java -cp /home/ec2-user/clustercluster-conf:/home/ec2-user/clustergobblin-jars* -Xmx-Xms1G  gobblin.aws.GobblinAWSClusterMaster --app_name cluster --gobblin.aws.work.dir /home/ec2-user/clusterwork-dir 1>/home/ec2-user/clusterlog-dirGobblinAWSClusterMaster.master.stdout 2>/home/ec2-user/clusterlog-dirGobblinAWSClusterMaster.master.stderr
