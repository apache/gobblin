...
public interface StreamCodec {
   ...
   * encoders the bytes flowing through.
   * @param origStream Stream to wrap
   * @return A wrapped stream for encoding
   */
  OutputStream wrapOutputStream(OutputStream origStream) throws IOException;
   ...
   */
  InputStream wrapInputStream(InputStream origStream) throws IOException;
