...
public class ConfigurationKeys {
  ...
  public static final String MAX_TASK_CROSSEXECUTION_TASK_RETRIES_KEY = "task.crossexecution.maxretries";
  public static final int DEFAULT_MAX_CROSSEXECUTION_TASK_RETRIES_KEY = 5;
