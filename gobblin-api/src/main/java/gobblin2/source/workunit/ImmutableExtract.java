 ...
 */
package gobblin2.source.workunit;

import gobblin2.configuration.SourceState;
...
public class ImmutableExtract extends org.apache.gobblin.source.workunit.ImmutableExtract {
  ...
  public ImmutableExtract(SourceState state, gobblin2.source.workunit.Extract.TableType type, String namespace, String table) {
