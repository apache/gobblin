...
public class HdfsWriter extends HdfsIO {
  ...
  private static PathFilter createGlobFilterForExtension(String extension) throws IOException {
    ...
    return new GlobFilter("*" + extension);
  }
}
