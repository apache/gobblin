...
@Slf4j
public class HiveMetaStoreRegisterWithoutComputingPartitionDiff extends HiveMetaStoreBasedRegister {
  public HiveMetaStoreRegisterWithoutComputingPartitionDiff(State state, Optional<String> metastoreURI) throws IOException {
    super(state, metastoreURI);
  }

  @Override
  protected void OnPartitionExist(IMetaStoreClient client, Table table, HivePartition partition,
