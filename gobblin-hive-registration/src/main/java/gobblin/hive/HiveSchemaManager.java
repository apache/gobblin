...
public abstract class HiveSchemaManager {
   ...
   *
   * For example, when registering Avro tables, one needs to specify either "avro.schema.literal"
   * or "avro.schema.url" in the {@link SerDeInfo}.
   *
   * @param si
   * @param registrable
   */
  public abstract void addSchemaProperties(SerDeInfo si, HiveRegistrable registrable);
