...
public class GobblinYarnConfigurationKeys {
  ...
  /**
   * Max time (minutes) to wait for application to reach terminal state after sending graceful shutdown signal.
   * Default 10. A longer value allows the AM more time to clean up but can delay launcher shutdown.
   */
