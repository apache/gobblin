...
public class SimpleVersionFinder implements VersionFinder<String> {
  ...
  public Collection<String> getValidVersions(Collection<String> input) {
    if (input == null)
      return null;
  ...
  @Override
  public String getCurrentVersion(Collection<String> input) {
    if (input == null)
      return null;
  ...
  private String compare(String input1, String input2) {
