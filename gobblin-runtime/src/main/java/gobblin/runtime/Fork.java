...
public class Fork implements Closeable, Runnable, FinalState {
  ...
  private final InstrumentedDataWriterDecorator<Object> writer;
  ...
  /**
   * Get final state for this object, obtained by merging the final states of the constructs generated by this
   * fork.
   * @return Merged {@link gobblin.configuration.State} of final states for constructs in this fork.
   */
  public State getFinalState() {
    State state = this.converter.getFinalState();
    state.addAll(this.rowLevelPolicyChecker.getFinalState());
    state.addAll(this.writer.getFinalState());
    return state;
  }
