...
/**
 * A {@link DatasetStateStoreEntryMetadata} generated by {@link FsDatasetStateStore}.
 */
public class FsDatasetStateStoreEntryMetadata extends DatasetStateStoreEntryMetadata<JobState.DatasetState> {

  private final FsDatasetStateStore stateStore;

  public FsDatasetStateStoreEntryMetadata(FileStatus fileStatus, FsDatasetStateStore stateStore) {
