...
public class LeasedToAnotherStatus extends LeaseAttemptStatus {
  ...
  protected LeasedToAnotherStatus(long reminderEventTimeMillis, long minimumReminderWaitMillis) {
    super();
    this.reminderEventTimeMillis = reminderEventTimeMillis;
    this.minimumReminderWaitMillis = minimumReminderWaitMillis;
  }
}
