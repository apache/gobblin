...
public class MysqlBaseSpecStore extends InstrumentedSpecStore {
  ...
  private static final String GET_ALL_STATEMENT_LIMIT_OFFSET = "SELECT spec_uri, spec FROM %s ORDER BY modified_time DESC LIMIT %d OFFSET %d";
  ...
  protected class SqlStatements {
    ...
    public final String getAllStatementLimitOffset = String.format(getTablelessGetAllStatementLimitOffset(), MysqlBaseSpecStore.this.tableName,
        MysqlBaseSpecStore.this.count, MysqlBaseSpecStore.this.start);
    ...
    protected String getTablelessGetAllStatementLimitOffset() { return MysqlBaseSpecStore.GET_ALL_STATEMENT_LIMIT_OFFSET; }
  }
