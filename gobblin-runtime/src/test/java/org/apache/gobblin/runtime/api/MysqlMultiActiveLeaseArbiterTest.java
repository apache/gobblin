...
public class MysqlMultiActiveLeaseArbiterTest {
  ...
  /*
     ...
     `skipFlowExecutionIdReplacement` to false.
  */
  ...
  public void testAcquireLeaseSingleParticipant() throws Exception {
    ...
    MultiActiveLeaseArbiter.LeaseAttemptStatus firstLaunchStatus =
        mysqlMultiActiveLeaseArbiter.tryAcquireLease(launchDagAction, eventTimeMillis, false, false);
    ...
    MultiActiveLeaseArbiter.LeaseAttemptStatus killStatus =
        mysqlMultiActiveLeaseArbiter.tryAcquireLease(killDagAction, eventTimeMillis, false, false);
  ...
  */
  ...
  public void testOlderReminderEventAcquireLease() throws IOException {
    ...
    LeaseAttemptStatus attemptStatus =
        mysqlMultiActiveLeaseArbiter.tryAcquireLease(resumeDagAction, olderEventTimestamp, true, false);
   ...
   */
   ...
   /*
   Tests calling `tryAcquireLease` when `skipFlowExecutionIdReplacement` is set to True and verify that flowExecutionId
   returned is the same as flowExecutionId provided to it for a LeaseObtainedStatus and LeasedToAnotherStatus object
   (CASE 1 & 2).
   */
  @Test
  public void testSkipFlowExecutionIdReplacement() throws IOException {
    // Obtain a lease for a new action and verify its flowExecutionId is not updated
    MultiActiveLeaseArbiter.LeaseAttemptStatus firstLaunchStatus =
        mysqlMultiActiveLeaseArbiter.tryAcquireLease(launchDagAction2, eventTimeMillis, false, true);
    Assert.assertTrue(firstLaunchStatus instanceof MultiActiveLeaseArbiter.LeaseObtainedStatus);
    MultiActiveLeaseArbiter.LeaseObtainedStatus firstObtainedStatus =
        (MultiActiveLeaseArbiter.LeaseObtainedStatus) firstLaunchStatus;
