...
public class MysqlDagActionStoreTest {
  ...
  public void testAddAction() throws Exception {
    ...
    this.mysqlDagActionStore.addDagAction(flowGroup, flowName, flowExecutionId_2, DagActionStore.DagActionValue.KILL);
  }

  @Test(dependsOnMethods = "testAddAction")
  public void testExists() throws Exception {
    Assert.assertTrue(this.mysqlDagActionStore.exists(flowGroup, flowName, flowExecutionId, DagActionStore.DagActionValue.KILL));
    Assert.assertTrue(this.mysqlDagActionStore.exists(flowGroup, flowName, flowExecutionId, DagActionStore.DagActionValue.RESUME));
    Assert.assertTrue(this.mysqlDagActionStore.exists(flowGroup, flowName, flowExecutionId_2, DagActionStore.DagActionValue.KILL));
    Assert.assertFalse(this.mysqlDagActionStore.exists(flowGroup, flowName, flowExecutionId_3, DagActionStore.DagActionValue.RESUME));
    Assert.assertFalse(this.mysqlDagActionStore.exists(flowGroup, flowName, flowExecutionId_3, DagActionStore.DagActionValue.KILL));
  }

  @Test(dependsOnMethods = "testExists")
  public void testGetAction() throws IOException, SQLException {
    Assert.assertEquals(new DagActionStore.DagAction(flowGroup, flowName, flowExecutionId, DagActionStore.DagActionValue.KILL),
        this.mysqlDagActionStore.getDagAction(flowGroup, flowName, flowExecutionId, DagActionStore.DagActionValue.KILL));
    Assert.assertEquals(new DagActionStore.DagAction(flowGroup, flowName, flowExecutionId_2, DagActionStore.DagActionValue.KILL),
        this.mysqlDagActionStore.getDagAction(flowGroup, flowName, flowExecutionId_2, DagActionStore.DagActionValue.KILL));
    ...
    set.add(new DagActionStore.DagAction(flowGroup, flowName, flowExecutionId, DagActionStore.DagActionValue.RESUME));
  ...
  public void testDeleteAction() throws IOException, SQLException {
   this.mysqlDagActionStore.deleteDagAction(flowGroup, flowName, flowExecutionId, DagActionStore.DagActionValue.KILL);
   Assert.assertEquals(this.mysqlDagActionStore.getDagActions().size(), 1);
   Assert.assertFalse(this.mysqlDagActionStore.exists(flowGroup, flowName, flowExecutionId, DagActionStore.DagActionValue.KILL));
    Assert.assertTrue(this.mysqlDagActionStore.exists(flowGroup, flowName, flowExecutionId_2, DagActionStore.DagActionValue.RESUME));
   Assert.assertTrue(this.mysqlDagActionStore.exists(flowGroup, flowName, flowExecutionId_2, DagActionStore.DagActionValue.KILL));
   Assert.assertNull( this.mysqlDagActionStore.getDagAction(flowGroup, flowName, flowExecutionId, DagActionStore.DagActionValue.KILL));
  }
