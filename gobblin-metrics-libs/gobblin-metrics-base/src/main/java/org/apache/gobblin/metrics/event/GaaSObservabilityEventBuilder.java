 ...
 * instances of {@link GobblinTrackingEvent}. Different types of events can be defined from {@link GaaSObservabilityEventBuilder},
 ...
 *
 * Note: a {@link GaaSObservabilityEventBuilder} instance is not reusable
 */
@ToString
public class GaaSObservabilityEventBuilder extends GobblinEventBuilder {
  ...
  public GaaSObservabilityEventBuilder(String name) {
    this(name, null);
  }

  public GaaSObservabilityEventBuilder(String name, String namespace) {
  ...
  public GobblinTrackingEvent build() {
    return new GaaSObservabilityEventExperimental(
  }
  /**
   * Submit the event
   * @deprecated Use {@link EventSubmitter#submit(MetricContext, GaaSObservabilityEventBuilder)}
   */
  @Deprecated
