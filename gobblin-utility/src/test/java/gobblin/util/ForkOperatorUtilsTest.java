...
public class ForkOperatorUtilsTest {
  ...
  /**
   * Test for {@link ForkOperatorUtils#getConverterPropertyNameForBranch(WorkUnitState, String)}.
   */
  @Test
  public void testGetConverterPropertyNameForBranch() {
    ...
    Assert.assertEquals(ForkOperatorUtils.getConverterPropertyNameForBranch(workUnitState, PROPERTY_FOO), PROPERTY_FOO);
