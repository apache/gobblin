...
public class Fork implements Closeable {
    ...
    public Fork(TaskContext taskContext, TaskState taskState, Object schema,
                int branches, int index) throws Exception {
    ...
    public void processRecord(Object record) throws Exception {
        Object convertedRecord = this.converter.convertRecord(this.convertedSchema, record, this.taskState);
        if (convertedRecord != null &&
                rowLevelPolicyChecker.executePolicies(convertedRecord, rowLevelPolicyCheckingResult)) {
     ...
     * @throws Exception
     */
    public void commit(long recordsPulled, long expectedCount, long pullLimit) throws Exception {
    ...
    /**
     * Build a {@link com.linkedin.uif.writer.DataWriter} for writing fetched data records.
     */
    @SuppressWarnings("unchecked")
    private DataWriter<Object> buildWriter() throws IOException, SchemaConversionException {
        ...
        return this.taskContext.getDataWriterBuilder(this.branches, this.index)
                .writeTo(Destination.of(
                        this.taskContext.getDestinationType(this.branches, this.index), this.taskState))
                ...
                .forBranch(this.branches > 1 ? this.index : -1)
                .build();
    }
    ...
    private boolean checkDataQuality(long recordsPulled, long expectedCount,
                                     long pullLimit, Object schema) throws Exception {
