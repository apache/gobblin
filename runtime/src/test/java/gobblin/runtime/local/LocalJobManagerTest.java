...
public class LocalJobManagerTest {
  ...
  public void startUp()
    ...
    this.properties.load(new FileReader("test/resource/gobblin.test.properties"));
  ...
  public void runTest1()
    ...
    jobProps.load(new FileReader("test/resource/job-conf/GobblinTest1.pull"));
  ...
  public void runTest2()
      throws Exception {
    Properties jobProps = new Properties();
    jobProps.load(new FileReader("test/resource/job-conf/GobblinTest2.pull"));
    jobProps.putAll(this.properties);
    jobProps.setProperty(SOURCE_FILE_LIST_KEY, "test/resource/source/test.avro.2,test/resource/source/test.avro.3");
    jobProps.setProperty(ConfigurationKeys.JOB_RUN_ONCE_KEY, "true");
