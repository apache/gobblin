...
public class MultiConverterTest {
  ...
  public void testConversion()
    ...
    Schema schema = (Schema) this.multiConverter.convertSchema(TEST_SCHEMA, workUnitState);
    ...
    GenericRecord record = (GenericRecord) this.multiConverter.convertRecord(TEST_SCHEMA, TEST_RECORD, workUnitState);
