...
public class CopyableDatasetMetadata {
  ...
  public static CopyableDatasetMetadata deserialize(String serialized) {
    return GSON.fromJson(serializedWithNewPackage(serialized), CopyableDatasetMetadata.class);
  }
   ...
   * @return
   */
  private static String serializedWithNewPackage(String serialized) {
