...
public class CopyEntity implements HasGuid {
  ...
  public static CopyEntity deserialize(String serialized) {
    return GSON.fromJson(serializedWithNewPackage(serialized), CopyEntity.class);
  }
  ...
  public static List<CopyEntity> deserializeList(String serialized) {
    return GSON.fromJson(serializedWithNewPackage(serialized), new TypeToken<List<CopyEntity>>() {}.getType());
  }
   ...
   * @return
   */
  public static String serializedWithNewPackage(String serialized) {
