...
public class RecursiveCopyableDataset implements CopyableDataset {
  ...
  @Override public List<CopyableFile> getCopyableFiles(FileSystem targetFileSystem) throws IOException {
    List<FileStatus> files = FileListUtils.listFilesRecursively(this._fs, this.rootPath);
    ...
    for(FileStatus file : files) {
      ...
      copyableFiles.add(new CopyableFile(file, outputPath, ownerAndPermission, ancestorOwnerAndPermissions,
