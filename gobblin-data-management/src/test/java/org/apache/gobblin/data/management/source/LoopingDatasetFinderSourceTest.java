...
public class LoopingDatasetFinderSourceTest {
  ...
  public void testNonDrilldown() {
    ...
    Assert.assertNull(workUnits.get(0).getProp(ConfigurationKeys.DATASET_URN_KEY));
    ...
    Assert.assertNull(workUnits.get(1).getProp(ConfigurationKeys.DATASET_URN_KEY));
    ...
    Assert.assertNull(workUnits.get(2).getProp(ConfigurationKeys.DATASET_URN_KEY));
  ...
  public void testNonDrilldownDatasetState()
    ...
    SourceState sourceState = new SourceState();
    sourceState.setProp(LoopingDatasetFinderSource.MAX_WORK_UNITS_PER_RUN_KEY, 3);
    sourceState.setProp(ConfigurationKeys.GLOBAL_WATERMARK_DATASET_URN, "__globalWatermark");
    ...
    Assert.assertEquals(workUnits.get(3).getProp(ConfigurationKeys.DATASET_URN_KEY), "__globalWatermark");
    Assert.assertEquals(workUnits.get(3).getProp(LoopingDatasetFinderSource.DATASET_URN), "dataset3");
    Assert.assertNull(workUnits.get(3).getProp(LoopingDatasetFinderSource.PARTITION_URN));
    Dataset globalWmDataset = new SimpleDatasetForTesting("__globalWatermark");
    ...
    Assert.assertTrue(workUnits.get(2).getPropAsBoolean(LoopingDatasetFinderSource.END_OF_DATASETS_KEY));
    Assert.assertEquals(workUnits.get(2).getProp(ConfigurationKeys.DATASET_URN_KEY), "__globalWatermark");
    Assert.assertEquals(workUnits.get(2).getProp(LoopingDatasetFinderSource.DATASET_URN), "dataset5");
    Assert.assertNull(workUnits.get(2).getProp(LoopingDatasetFinderSource.PARTITION_URN));
    ...
    Assert.assertNull(workUnits.get(0).getProp(DatasetFinderSourceTest.PARTITION_URN));
    Assert
        .assertEquals(workUnits.get(0).getLowWatermark(LongWatermark.class).getValue(), watermarks1.get(0).getValue());
    ...
    Assert.assertNull(workUnits.get(1).getProp(DatasetFinderSourceTest.PARTITION_URN));
    Assert
        .assertEquals(workUnits.get(1).getLowWatermark(LongWatermark.class).getValue(), watermarks1.get(1).getValue());
    ...
    Assert.assertNull(workUnits.get(2).getProp(DatasetFinderSourceTest.PARTITION_URN));
    Assert
        .assertEquals(workUnits.get(2).getLowWatermark(LongWatermark.class).getValue(), watermarks1.get(2).getValue());
  ...
  public void testDrilldownDatasetState()
    ...
    Assert.assertTrue(workUnits.get(1).getPropAsBoolean(LoopingDatasetFinderSource.END_OF_DATASETS_KEY));
    Assert.assertEquals(workUnits.get(1).getProp(ConfigurationKeys.DATASET_URN_KEY), "__globalWatermark");
    ...
    Assert.assertEquals(workUnits.get(3).getProp(LoopingDatasetFinderSource.DATASET_URN), "dataset2");
    Assert.assertEquals(workUnits.get(3).getProp(LoopingDatasetFinderSource.PARTITION_URN), "p2");
    datasets4.add(new SimpleDatasetForTesting("__globalWatermark"));
  ...
  public void testDatasetStates(List<Dataset> datasets, List<LongWatermark> watermarks, String jobName)
      throws IOException {
    Preconditions.checkArgument(datasets.size() >= 2);
    for (int i = 0; i < datasets.size(); i++) {
