...
public class HivePurgerConfigurationKeys {
  ...
  public static final String MAX_WORKUNITS_KEY = HIVE_PURGER_PREFIX + ".max.workunits";

  public static final String NO_PREVIOUS_WATERMARK = HIVE_PURGER_PREFIX + ".no.watermark";
  ...
  public static final String MAX_WORKUNIT_EXECUTION_ATTEMPTS_KEY = HIVE_PURGER_PREFIX + ".max.execution.attempts";
  ...
  public static final String COMPLIANCE_ID_TABLE_KEY = HIVE_PURGER_PREFIX + ".compliance.id.table";

  // Name of the coloumn in the compliance id table containing compliance id.
  public static final String COMPLIANCE_ID_IDENTIFIER_KEY = HIVE_PURGER_PREFIX + ".compliance.identifier";
}
