...
public class TaskState extends WorkUnitState {
    ...
    /**
     * Get the ID of the job this {@link com.linkedin.uif.scheduler.TaskState} is for.
     *
     * @return ID of the job this {@link com.linkedin.uif.scheduler.TaskState} is for
     */
    ...
    /**
     * Get the ID of the task this {@link com.linkedin.uif.scheduler.TaskState} is for.
     *
     * @return ID of the task this {@link com.linkedin.uif.scheduler.TaskState} is for
     */
